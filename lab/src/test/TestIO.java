...
public class TestIO {
	...
	public static void main(String[] args) {
		...
		String savefilepath="/Users/samngai/"+user.getUserName()+".blog";
		...
		String loadfilepath="/Users/samngai/"+user.getUserName()+".blog";
		    //if the path is not accessible, change it to any path you can access
		...
		anyblog.load("/Users/samngai/non-exist.blog");
